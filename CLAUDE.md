...
| # | 역할 | 담당 |
|---|------|------|
| 1 | Architect | 헥사고날 준수, 의존 방향, SOLID, 모듈 경계 |
| 2 | Security | OWASP, 민감 데이터 마스킹, 인증/인가 |
| 3 | Performance | N+1, Kafka/Redis/ES 설정, 동시성 |
| 4 | Code Quality | 클린 코드, Kotlin 관용구, 네이밍 |
| 5 | Testing | 테스트 존재 여부, 커버리지, 누락 시나리오 |
| 6 | Domain Expert | FDS 비즈니스 로직 정확성, 도메인 모델링 |

**Leads (순차 실행 — 리뷰어 완료 후)**
| 역할 | 담당 | 참조 문서 |
|------|------|-----------|
| Tech Lead | Reviewer 1~3 종합, 기술 심각도, 반복 실수 추적 | project-context, review-checklist |
| Quality Lead | Reviewer 4~6 종합, 품질 심각도, 학습 추출 | domain-glossary, review-checklist |
